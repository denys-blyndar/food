...
function calc() {
  ...
  function initLocalSelector(selector, activeClass) {
  ...
  initLocalSelector('#gender div', 'calculating__choose-item_active');
  initLocalSelector(
...
function forms(formSelector, modalTimerId) {
  ...
  const message = {
    ...
    success: "Дякую! Ми зв'яжемося з вами якнайшвидше!",
